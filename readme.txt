...
Please note that this plugin is design to work with the [Advanced Custom Fields](http://wordpress.org/plugins/advanced-custom-fields/) plugin. It is possible to use this plugin without that ACF, please read the [Other Notes](http://wordpress.org/plugins/blunt-snippets/other_notes/) section for additional information.

With or without ACF this is a no frills plugins.
...
1. Click "Add Snippet"
2. Add a new custom field name = "" Set the value to 1 for active and 0 to make the snippet inactive
3. Add a new custom field name = "" Enter your code snippet for the value
...
* Added code so that you can switch between ACF and non-ACF and everything keeps working and data is lost.
